...
import { llmRouter } from '../services/content-generation/llm-router.js';
import { treeOfThought } from '../services/content-generation/tree-of-thought.js';
import { beamSearchScriptGenerator } from '../services/content-generation/beam-search-script.js';
 ...
 */
export async function exploreNarrativePaths(
  input: ExploreNarrativePathsInput
): Promise<ExploreNarrativePathsResult> {
...
export async function generateScriptCandidates(
  input: GenerateScriptCandidatesInput
): Promise<GenerateScriptCandidatesResult> {
  ...
  const narrativeNode: import('../shared/types/index.js').TreeOfThoughtNode = {
    id: 'narrative-1',
  ...
  const result = await customBeamSearch.generate(
    videoIdea,
    narrativeNode,
    input.nicheId,
    input.channelDNA
 ...
 */
export async function waitForScriptApproval(
  input: WaitForScriptApprovalInput
): Promise<WaitForScriptApprovalResult> {
 ...
 */
export async function waitForFinalQC(
  input: WaitForFinalQCInput
): Promise<WaitForFinalQCResult> {
...
export async function uploadToYouTube(
  input: UploadToYouTubeInput
): Promise<UploadToYouTubeResult> {

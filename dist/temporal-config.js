 ...
 */
export async function startContentWorkflow(projectId, config) {
    const client = await createTemporalClient();
 ...
 */
export async function sendApprovalSignal(workflowId, approved, selectedScriptId, selectedThumbnailId) {
    const client = await createTemporalClient();
    const handle = client.getHandle(workflowId);
...
//# sourceMappingURL=temporal-config.js.map
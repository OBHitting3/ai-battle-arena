...
export type VideoProjectStatus = 'ideation' | 'script_generation' | 'script_approval_pending' | 'voiceover_generation' | 'asset_sourcing' | 'video_assembly' | 'post_production' | 'thumbnail_generation' | 'thumbnail_approval_pending' | 'final_qc_pending' | 'scheduled' | 'published' | 'failed';
...
export type YouTubeCategory = 'Film & Animation' | 'Autos & Vehicles' | 'Music' | 'Pets & Animals' | 'Sports' | 'Travel & Events' | 'Gaming' | 'People & Blogs' | 'Comedy' | 'Entertainment' | 'News & Politics' | 'Howto & Style' | 'Education' | 'Science & Technology' | 'Nonprofits & Activism';

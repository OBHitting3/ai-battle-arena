...
const { exploreNarrativePaths, generateScriptCandidates, waitForScriptApproval, generateVoiceover, assembleVideo, generateThumbnail, waitForFinalQC, uploadToYouTube, trackAnalytics } = proxyActivities({
 ...
 */
export async function contentCreationWorkflow(input) {
    const errors = [];
    try {
...
//# sourceMappingURL=content-workflow.js.map
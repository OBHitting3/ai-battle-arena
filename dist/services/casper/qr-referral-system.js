...
export class QRReferralSystem {
     ...
     */
    handleScan(referralCode) {
        const referrer = Object.values(this.users).find(user => user.referralCode === referralCode);
        if (!referrer) {
     ...
     */
    async handleSignup(newUsername, newEmail, referralCode) {
        const referrer = Object.values(this.users).find(user => user.referralCode === referralCode);
        if (!referrer) {
            throw new Error('Invalid referral code');
        }
     ...
     */
    displayTeamLeaderboard(limit = 10) {
...
//# sourceMappingURL=qr-referral-system.js.map
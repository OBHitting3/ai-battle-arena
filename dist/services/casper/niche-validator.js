...
export class CasperNicheValidator {
     ...
     */
    async searchNiche(keyword, maxResults = 50) {
        try {
     ...
     */
    calculateProfitMetrics(videoStats) {
     ...
     */
    determineRejectionReason(metrics) {
     ...
     */
    async findAlternatives(originalNiche, originalAnalysis) {
        const alternatives = [];
...
//# sourceMappingURL=niche-validator.js.map
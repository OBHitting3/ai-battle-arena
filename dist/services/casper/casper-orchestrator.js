...
import { EvaluatorDebateSystem } from './evaluator-debate-system';
...
export class CasperOrchestrator {
    ...
    async createVideo(request) {
        console.log('\n' + '═'.repeat(100));
        console.log('👻 CASPER - THE FACELESS GHOST');
        ...
        if (!nicheValidation.approved) {
            console.log('\n❌ NICHE REJECTED - Cannot proceed with unprofitable niche');
            ...
            if (nicheValidation.alternatives.length > 0) {
                console.log('\n💡 Suggested profitable alternatives:');
        ...
        console.log('─'.repeat(100));
        const debateResult = await this.debateSystem.runDebate(aiGeneration.script, {
            niche: request.niche,
            topic: request.topic,
        ...
        console.log(`\n${approved ? '✅ APPROVED' : '⚠️  NEEDS IMPROVEMENT'}`);
        ...
        console.log('\n' + '═'.repeat(100));
        console.log(`🎬 VIDEO CREATION ${approved ? 'COMPLETE' : 'INCOMPLETE'}`);
     ...
     */
    async runComprehensiveTests(iterations = 100) {
        console.log('\n' + '═'.repeat(100));
        console.log(`🧪 RUNNING ${iterations} COMPREHENSIVE CASPER TESTS`);
        console.log('═'.repeat(100) + '\n');
        ...
        for (let i = 0; i < testCases.length; i++) {
            ...
            try {
                ...
                console.log(`\n❌ TEST ${runNumber} FAILED: ${error.message}`);
...
//# sourceMappingURL=casper-orchestrator.js.map
...
export class ThumbnailGenerator {
     ...
     */
    async callFireflyAPI(prompt, aspectRatio) {
        try {
 ...
 */
export function createThumbnailGenerator(apiKey) {
    return new ThumbnailGenerator(apiKey);
}
/**
 * Generate thumbnail from video title
 */
export async function generateThumbnailFromTitle(title, apiKey) {
